...
if(isset($_GET['id'])){
	...
	if(checkEntryPermission($entry_id) == false){

		header("location: user.php");

	}else{

		$entry_info = getEntryInfo($entry_id)['data'];
        ...
        <div class="row mt-5">
            <div class="col-md-10 m-auto">
                ...
                <form action="" method="post" role="form" class="php-email-form" id="create-entry-form">
                            <div class="casing" id='step1'>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="text" class="form-control" name="site_name" value="<?=$entry_info['site_name'];?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Date <small>Current <strong>"<?=$entry_info['entry_date'];?>"</strong> </small></label>
                                        <input value="<?=$entry_info['entry_date'];?>" type="text" class="form-control" name="entry_date" id="date">

                                        
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Site ID</label>
                                        <input value="<?=$entry_info['site_id'];?>" type="text" class="form-control" name="site_id">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Site Address</label>
                                        <textarea class="form-control" name="site_address" rows="2  "><?=$entry_info['site_address'];?></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">COORDINATES</label>
                                        <input value="<?=$entry_info['coordinates'];?>" type="text" class="form-control" name="coordinates" id="coordinates">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Site Description</label>
                                        <textarea class="form-control" name="site_description"  rows="2"><?=$entry_info['site_description'];?></textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">(Residential, Industrial, Proximity to Hospital or School )</label>
                                        <input value="<?=$entry_info['hospital_proximity'];?>" type="text" class="form-control" name="hospital_proximity">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Date OF CONSTRUCTION<small>Current <strong>"<?=$entry_info['entry_date'];?>"</strong> </small></label>
                                        <input value="<?=$entry_info['construction_date'];?>" type="text" class="form-control" name="construction_date" id="construction_date">
                                        
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Altitude</label>
                                        <input value="<?=$entry_info['altitude'];?>" type="text" class="form-control" name="altitude">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Tower Type</label>
                                        <input value="<?=$entry_info['tower_type'];?>" type="text" class="form-control" name="tower_type">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Tenants</label>
                                        <input value="<?=$entry_info['tenants'];?>" type="text" class="form-control" name="tenants">
                                    </div>
                                </div>
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['compliance_degree'];?>" type="text" class="form-control" name="compliance_degree">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Submit report on Site Metrics</label>
                                        <input value="<?=$entry_info['site_metrics'];?>" type="text" class="form-control" name="site_metrics">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Batteries</label>
                                        <input value="<?=$entry_info['batteries'];?>" type="text" class="form-control" name="batteries" id="batteries">
                                        
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Filters</label>
                                        <input value="<?=$entry_info['filters'];?>" type="text" class="form-control" name="filters">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Spent oil</label>
                                        <input value="<?=$entry_info['spent-oil'];?>" type="text" class="form-control" name="spent-oil">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Other waste streams.</label>
                                        <input value="<?=$entry_info['other-waste-streams'];?>" type="text" class="form-control" name="other-waste-streams" id="other-waste-streams.">
                                    </div>
                                    <div class="form-group  col-md-10 col-md-10-offset-2 m-auto">
                                        ...
                                        <input value="<?=$entry_info['ascertain_sanitation'];?>" type="text" class="form-control" name="ascertain_sanitation">
                                    </div>
                                </div>
                            </div>
                            <div class="section-title">
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['co_ppm'];?>" type="text" name="co_ppm" class="form-control" id="co_ppm">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">CO2 %</label>
                                        <input value="<?=$entry_info['co2'];?>" type="text" class="form-control" name="co2" id="co2%">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">NO ppm or mg/m3</label>
                                        <input value="<?=$entry_info['no_ppm'];?>" type="text" class="form-control" name="no_ppm" id="noppmmg/m3">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">NO2 ppm or mg/m3</label>
                                        <input value="<?=$entry_info['no2'];?>" type="text" class="form-control" name="no2" id="no2ppmmg">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name"> SO2 ppm or mg/m3</label>
                                        <input value="<?=$entry_info['so2'];?>" type="text" class="form-control" name="so2" id="so2ppmmg/m3">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Suspended Particulate Matter (SPM) µg/m3</label>
                                        <input value="<?=$entry_info['suspended_particulate'];?>" type="text" class="form-control" name="suspended_particulate" id="suspended_particulate">
                                    </div>
                                </div>
                            </div>
                            <div class="section-title">
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['noise_level_measurement'];?>" type="text" name="noise_level_measurement" class="form-control" id="noise_level_measurement">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Noise level (1m, 10m,15m) in dB(A).</label>
                                        <input value="<?=$entry_info['noise_level'];?>" type="text" class="form-control" name="noise_level" id="noise_level">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Carry out full survey if >55dB(A)</label>
                                        <input value="<?=$entry_info['carry_out_full_survey'];?>" type="text" class="form-control" name="carry_out_full_survey" id="carry_out_full_survey">
                                    </div>
                                </div>
                            </div>
                            <div class="section-title">
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['check_compliance'];?>" type="text" name="check_compliance" class="form-control" id="check_compliance">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Check functionality of Aviation Warning Lights, Security Lights </label>
                                        <input value="<?=$entry_info['check_functionality'];?>" type="text" class="form-control" name="check_functionality" id="check_functionality">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Signage</label>
                                        <input value="<?=$entry_info['signage'];?>" type="text" class="form-control" name="signage" id="signage">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['carry_out_analyst'];?>" type="text" name="carry_out_analyst" class="form-control" id="carry_out_analyst">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Check if Surface/ground water is impacted, adequacy of Drainage, </label>
                                        <input value="<?=$entry_info['check_surface'];?>" type="text" class="form-control" name="check_surface" id="check_surface">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="CiSeofs">Check if Soil erosion originating from site</label>
                                        <input value="<?=$entry_info['ciseofs'];?>" type="text" class="form-control" name="ciseofs" id="ciseofs">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name">Check if Surface granite/soil staining</label>
                                        <input value="<?=$entry_info['check_if_surface_granite'];?>" type="text" class="form-control" name="check_if_surface_granite" id="check_if_surface_granite">
                                    </div>
                                    <div class="form-group col-md-6 mt-3">
                                        <label for="name"> Stagnant water on site</label>
                                        <input value="<?=$entry_info['stagnant_water_on_site'];?>" type="text" class="form-control" name="stagnant_water_on_site" id="stagnant_water_on_site">
                                    </div>
                                </div>
                            </div>
                            <div class="section-title">
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input value="<?=$entry_info['radiation_level'];?>" type="text" name="radiation_level" class="form-control" id="radiation_level">
                                    </div>
                                    <div class="form-group col-md-6 mt-3 mt-md-0">
                                        <label for="name">Check compliance to ICNIRP Limit µW/Cm2 for Mhz</label>
                                        <input value="<?=$entry_info['ICNIRP'];?>" type="text" class="form-control" name="ICNIRP" id="ICNIRP">
                                    </div>
                                </div>
                            </div>
                            <div class="section-title">
                            ...
                            <div class="casing">
                                <div class="row">
                                    <div class="form-group col-md-10 col-md-10-offset-2 m-auto">
                                        ...
                                        <input value="<?=$entry_info['hse_collaboration'];?>" type="text" name="hse_collaboration" class="form-control" id="hse_collaboration">
                                    </div>
                                </div>
                            </div>
                           <!--  <div class="section-title">
                    ...
                    <input type='hidden' name='entry_id' value="<?=$entry_info['entry_id'];?>">
       ...
       window.onload = function(){
         ...
         document.querySelector("#next-phase").addEventListener("click", function(){
                ...
                document.querySelector("#prevButton").innerHTML = "<button class='btn btn-md btn-warning' id='prev-button'>Previous</button>";
                 ...
                 document.querySelector("#next-phase").setAttribute("onclick", "updateEntry()");
       ...
       function formProgress(formStep){
        ...
        function updateEntry(){
                //document.querySelector("#create-entry-form").submit();
                   ...
                   $.post({
                            url: "process/loaders/update-entry-data.php",
        ...
        function firePermissionModal(){

        	$.get({


        		url: "process/loaders/getEntry.php",
        ...
        document.querySelector("#date").addEventListener("click", function(){
         ...
         document.querySelector("#date").addEventListener("blur", function(){
        		...
        		if(this.value.length == 0){
        			this.value = "<?php echo $entry_info['entry_date']; ?>";
        		}

        });


        document.querySelector("#construction_date").addEventListener("click", function(){
        		this.type = 'date';

        });

         document.querySelector("#construction_date").addEventListener("blur", function(){
        		this.type = 'text';
